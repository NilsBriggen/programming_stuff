...
class Scoreboard(Turtle):
    ...
    def GameOver(self):
        ...
        with open(f'{cwd}\\highscore.txt') as f:
            ...
            f.close()
        self.goto(0, -40)
        self.write(f"Press 'C' to clear the highscore", False, ALIGNEMENT, (FONT, FONTSIZE, FONTTYPE))
        self.goto(0, -80)
        self.write(f"Press 'R' to restart the game", False, ALIGNEMENT, (FONT, FONTSIZE, FONTTYPE))
